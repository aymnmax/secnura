...
function CompanyScan() {
  return (
    <div className="scan-stage" aria-label="Animated visual showing Secnura scanning a company's attack surface">
      <div className="scan-orb" />
      <div className="scan-grid" />
      <div className="scan-corner scan-corner-a" />
      <div className="scan-corner scan-corner-b" />
      <div className="scan-corner scan-corner-c" />
      <div className="scan-corner scan-corner-d" />

      <div className="scan-header">
        <span>SECNURA / LIVE SECURITY VIEW</span>
        <b>SCANNING</b>
      </div>
      ...
      <div className="scan-center">
        ...
        <div className="scan-logo-shell">
          <Shield className="scan-logo" />
          <div className="scan-line-sweep" />
        </div>
        <div className="scan-pulse pulse-a" />
        <div className="scan-pulse pulse-b" />
      </div>

      <div className="scan-side-card left">
        <span>ASSET DISCOVERY</span>
        <strong>28 endpoints</strong>
        <small>visibility expanding</small>
      </div>
      <div className="scan-side-card right">
        <span>RISK SIGNAL</span>
        <strong>PRIORITISED</strong>
        <small>attack paths mapped</small>
      </div>

      <div className="scan-feed">
        <div><span className="live-dot" /> External attack surface</div>
        <div>Application security <b>OK</b></div>
        <div>Credentials &amp; exposure <b>3 REVIEW</b></div>
      </div>

      <div className="scan-progress"><span /></div>
      <div className="scan-foot"><span>SECURITY POSTURE</span><strong>VISIBLE</strong></div>
    </div>
  );
}
        ...
        <section className="hero-section">
          <div className="container hero-grid">
            <div className="hero-copy">
              ...
              <h1>Make your security <span>visible.</span><br />Make your business <span>ready.</span></h1>
              <p className="hero-text">Secnura helps organisations understand their exposure, find what matters most, and build security that works in the real world — without the enterprise-only price tag.</p>
              <div className="hero-actions">
                <a className="button-primary" href="#contact">Start a security conversation <span>→</span></a>
                <a className="button-ghost" href="#services">Explore our services</a>
              </div>
              <div className="hero-trust">
                <div><strong>ATTACK-MINDED</strong><span>See risk like an adversary.</span></div>
                <div><strong>BUSINESS-AWARE</strong><span>Prioritise what changes outcomes.</span></div>
                <div><strong>ACCESSIBLE</strong><span>Security without the premium barrier.</span></div>
              </div>
            </div>
            <CompanyScan />
          </div>
